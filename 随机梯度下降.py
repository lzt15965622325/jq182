...
z1 = [3,3,2,4,5,3,2,4,2]  # 房间数

def h0(o0, o1, o2, x, z):
    return o1 * x + o2 * z + o0
# 根据对o0 o1 o2求导，分别求和得
def get_o0(o0, o1, o2, x, z):
    each = random.randint(0, 8)
    s = h0(o0, o1, o2, x1[each], z1[each]) - y1[each]
    return s
def get_o1(o0, o1, o2, x, z):
    each = random.randint(0, 4)
    s = (h0(o0, o1, o2, x1[each], z1[each]) - y1[each]) * x1[each]
    return s
def get_o2(o0, o1, o2, x, z):
    each = random.randint(0, 4)
    s = (h0(o0, o1, o2, x1[each], z1[each]) - y1[each]) * z1[each]
    return s
def main():
    a0 = a1 = a2 = 0
    ...
    while abs(b0) > 0.01 or abs(b1) > 0.01 or abs(b2) > 0.01:
        a0 = a0 - 0.03 * b0
        a1 = a1 - 0.03 * b1
        a2 = a2 - 0.03 * b2
        b0 = get_o0(a0, a1, a2, x1, z1)
